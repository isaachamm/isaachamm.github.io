...
export default function About() {
	...
	return (
		<>
			...
			<div className='md:w-[70%] text-left px-4'>

				<br />
				<div className='w-full text-left items-center md:block flex flex-col'>
					<img src={selfPortrait} alt="Self Portrait"
						className='md:float-right justify-center max-w-xs w-full h-auto '
					/>
